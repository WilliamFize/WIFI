...
{
    u32 u32IntSts = ((uint32_t)(((USBD_T *) ((( uint32_t)0x40000000) + 0x60000))->INTSTS));
    u32 u32State = ((uint32_t)(((USBD_T *) ((( uint32_t)0x40000000) + 0x60000))->ATTR & 0xf));


    if(u32IntSts & (1ul << 2))
    {
        
        (((USBD_T *) ((( uint32_t)0x40000000) + 0x60000))->INTSTS = ((1ul << 2)));

        if(((uint32_t)(((USBD_T *) ((( uint32_t)0x40000000) + 0x60000))->FLDET & (1ul << 0))))
        {
             
            ((uint32_t)(((USBD_T *) ((( uint32_t)0x40000000) + 0x60000))->ATTR |= ((1ul << 7)|(1ul << 4))));
        }
        else
        {
             
            ((uint32_t)(((USBD_T *) ((( uint32_t)0x40000000) + 0x60000))->ATTR &= ~(1ul << 7)));
        }
    }
    ...
    if(u32IntSts & (1ul << 0))
    {
        ...
        (((USBD_T *) ((( uint32_t)0x40000000) + 0x60000))->INTSTS = ((1ul << 0)));
        ...
        if(u32State & (1ul << 1))
        {
            ...
            ((uint32_t)(((USBD_T *) ((( uint32_t)0x40000000) + 0x60000))->ATTR &= ~(1ul << 4)));
        }
        if(u32State & (1ul << 2))
        {
    ...
    if(u32IntSts & (1ul << 1))
    {
        ...
        if(u32IntSts & (1ul << 31))
        {
            ...
            (((USBD_T *) ((( uint32_t)0x40000000) + 0x60000))->INTSTS = ((1ul << 31)));

             
            (*((volatile uint32_t *) ((uint32_t)&((USBD_T *) ((( uint32_t)0x40000000) + 0x60000))->EP[0]. CFGP + (uint32_t)((0) << 4))) |= (1ul << 0));
            (*((volatile uint32_t *) ((uint32_t)&((USBD_T *) ((( uint32_t)0x40000000) + 0x60000))->EP[0]. CFGP + (uint32_t)((1) << 4))) |= (1ul << 0));
        ...
        switch(buf[1])
        {
            case 0x09:
            {
                if(buf[3] == 3)
                {
                    ...
                    (*((volatile uint32_t *) ((uint32_t)&((USBD_T *) ((( uint32_t)0x40000000) + 0x60000))->EP[0]. CFG + (uint32_t)((1) << 4))) |= (1ul << 7));
...
{
	SYS_UnlockReg();
	CLK_EnableModuleClock(((((1) & 0x03) << 30)|(((27) & 0x1f) << 0) | (((0x0) & 0x03) << 28)|(((0x0) & 0x07) << 25)|(((0x0) & 0x1f) << 20)| (((0) & 0x03) << 18)|(((0x0F) & 0xff) << 10)|(((4) & 0x1f) << 5)));
    CLK_SetModuleClock(((((1) & 0x03) << 30)|(((27) & 0x1f) << 0) | (((0x0) & 0x03) << 28)|(((0x0) & 0x07) << 25)|(((0x0) & 0x1f) << 20)| (((0) & 0x03) << 18)|(((0x0F) & 0xff) << 10)|(((4) & 0x1f) << 5)), 0, (((3)-1) << 4));
    ...
    (*((volatile uint32_t *) ((uint32_t)&((USBD_T *) ((( uint32_t)0x40000000) + 0x60000))->EP[0]. CFG + (uint32_t)((0) << 4))) = ((1ul << 9) | (2ul << 5) | 0));
     
    (*((volatile uint32_t *) ((uint32_t)&((USBD_T *) ((( uint32_t)0x40000000) + 0x60000))->EP[0]. BUFSEG + (uint32_t)((0) << 4))) = ((0 + 8)));

     
    (*((volatile uint32_t *) ((uint32_t)&((USBD_T *) ((( uint32_t)0x40000000) + 0x60000))->EP[0]. CFG + (uint32_t)((1) << 4))) = ((1ul << 9) | (1ul << 5) | 0));
...
{
    u8 *ptr;
    ptr = (u8 *)((((( uint32_t)0x40000000) + 0x60000)+0x100) + ((uint32_t)*((volatile uint32_t *) ((uint32_t)&((USBD_T *) ((( uint32_t)0x40000000) + 0x60000))->EP[0]. BUFSEG + (uint32_t)((3) << 4)))));
	USBD_MemCopy(usb_recv.data[usb_recv.w_p], ptr, 64);
	(*((volatile uint32_t *) ((uint32_t)&((USBD_T *) ((( uint32_t)0x40000000) + 0x60000))->EP[0]. MXPLD + (uint32_t)((3) << 4))) = (64));
	usb_recv.w_p = (usb_recv.w_p + 1) & (8 - 1);
}
...
const u8 sucess_string[64] = "Receive ok\n";
const u8 fail_string[64]   = "Input error\n";
...
void UsbRecvPolling(void)
{
	...
	if(usb_recv.r_p != usb_recv.w_p)
	{
		...
		if(UsbStringCompare(ptr, &wpa) == 1)
		{
			memcpy(&wifi.wpa, &wpa, sizeof(WPA2_PSK_T));
			ptr = (u8 *)((((( uint32_t)0x40000000) + 0x60000)+0x100) + ((uint32_t)*((volatile uint32_t *) ((uint32_t)&((USBD_T *) ((( uint32_t)0x40000000) + 0x60000))->EP[0]. BUFSEG + (uint32_t)((2) << 4)))));
			USBD_MemCopy(ptr, (u8 *)sucess_string, 64);
			(*((volatile uint32_t *) ((uint32_t)&((USBD_T *) ((( uint32_t)0x40000000) + 0x60000))->EP[0]. MXPLD + (uint32_t)((2) << 4))) = (64));
			OLEDDMAClearPic();
			{(info . lang) ? (OLEDDMAShowStr("  SSID Set OK!  ", 0, 3)) : (OLEDDMAShowPic(image_ssid_set_ok, 128, 16, 0, 3));};;
			OLEDDMAUpdateImmediately();
			WifiCoreCommandSend(0x58, wifi.wpa.ssid, wifi.wpa.ssid_len);
			delay_ms(100);
			WifiCoreCommandSend(0x59, wifi.wpa.key, wifi.wpa.key_len);
			delay_ms(2000);
			SystemPowerDown();
		}
		else
		{
			ptr = (u8 *)((((( uint32_t)0x40000000) + 0x60000)+0x100) + ((uint32_t)*((volatile uint32_t *) ((uint32_t)&((USBD_T *) ((( uint32_t)0x40000000) + 0x60000))->EP[0]. BUFSEG + (uint32_t)((2) << 4)))));
			USBD_MemCopy(ptr, (u8 *)fail_string, 64);
			(*((volatile uint32_t *) ((uint32_t)&((USBD_T *) ((( uint32_t)0x40000000) + 0x60000))->EP[0]. MXPLD + (uint32_t)((2) << 4))) = (64));
		}
		usb_recv.r_p = (usb_recv.r_p + 1) & (8 - 1);
	}
}
...
void UsbRecvUidAes(void)
{
	...
	if(i != 16)
	{
		{(info . lang) ? (OLEDDMAShowStr(" Please Crack!  ", 0, 3)) : (OLEDDMAShowPic(image_please_crack, 128, 16, 0, 3));};;
		OLEDDMAUpdateImmediately();
		while(1)
		{
			if(usb_recv.r_p != usb_recv.w_p)
				...
				if(ptr[0] == 0xAA && ptr[1] == 0xEE)
				{
					switch(ptr[3])
					{
						...
						case 0x01:
							...
							if(i == 16)
							{
								{(info . lang) ? (OLEDDMAShowStr(" Crack Sucess!  ", 0, 3)) : (OLEDDMAShowPic(image_crack_sucess, 128, 16, 0, 3));};;
								OLEDDMAUpdateImmediately();
								delay_ms(2000);
								SystemPowerDown();
							}
