...
#line 103 "..\\user\\lcd.c"
static void LcdSpiSendCmd(u8 cmd)
{		
	u8 test;
...
static void LcdSpiSendDat(u8 dat)
{
...
void LcdSpiSetCol(u8 start, u8 end)
{
	LcdSpiSendCmd(0x21);
	LcdSpiSendCmd(start);
	LcdSpiSendCmd(end);
...
void LcdSpiSetPage(u8 start, u8 end)
{
	LcdSpiSendCmd(0x22);
	LcdSpiSendCmd(start);
	LcdSpiSendCmd(end);
...
#line 170 "..\\user\\lcd.c"
	...
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPC_MFP  &= ~((1UL<<8) | (1UL<<9) | (1UL<<10) | (1UL<<11));
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPC_MFP  |= ((1UL<<8) | (1UL<<9) | (1UL<<10) | (1UL<<11));
