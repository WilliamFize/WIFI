...
void SystemClockInit(void)
{
	...
	CLK_SetSysTickClockSrc((0x7UL<<3));
	((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL = ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL & ~(1 << 2U);
...
{	
	system_save_data[SAVE_FIRST_USER_ADDR]		= 0x20181016;
		
	system_save_data[SAVE_UNIT_ID_ADDR] 		= setid.local;

	system_save_data[SAVE_WIFI_CORE_VER_ADDR]	= U8_4_Change_U32(info.ver + 4);

	system_save_data[SAVE_INFO_STAT_BIT_ARRR]	= mic.enable  << 0  |
												  sign.enable << 1 |
												  vote.enable << 2;
...
void SystemGlobalInit(void)
{
	...
	sprintf(info.ver, "2.5&x.x    ");
	
	if(system_save_data[SAVE_FIRST_USER_ADDR] != 0x20181016)
	{
		setid.local	= 0x3001;
		mic.enable	= 1;
		sign.enable	= 1;
	...
	{		
		...
		sign.enable	= ((system_save_data[SAVE_INFO_STAT_BIT_ARRR] & (1<<1))>>1);

		vote.enable	= ((system_save_data[SAVE_INFO_STAT_BIT_ARRR] & (1<<2))>>2);

		mic.enable 	= ((system_save_data[SAVE_INFO_STAT_BIT_ARRR] & (1<<0))>>0);

		U32_Change_U8_4(system_save_data[SAVE_WIFI_CORE_VER_ADDR], info.ver + 4);
	...
	info.master_unit = !(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0UL))) + ((14)<<2))));
	if(info.master_unit)
		mic.nos_tmr = 0;
...
{
	*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x4000) + (1UL << 6))) = (*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x4000) + (1UL << 6))) & ~(0x3 << (8 << 1))) | (0x1UL << (8 << 1));
	(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(1UL))) + ((8)<<2)))) = 0;
	
	*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x4000) + (1UL << 6))) = (*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x4000) + (1UL << 6))) & ~(0x3 << (14 << 1))) | (0x0UL << (14 << 1));

	*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x4000) + (1UL << 6))) = (*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x4000) + (1UL << 6))) & ~(0x3 << (6 << 1))) | (0x3UL << (6 << 1));
	(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(1UL))) + ((6)<<2)))) = 1;
	
	*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x4000) + (1UL << 6))) = (*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x4000) + (1UL << 6))) & ~(0x3 << (7 << 1))) | (0x3UL << (7 << 1));
	(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(1UL))) + ((7)<<2)))) = 1;
	
	*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x4000) + (2UL << 6))) = (*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x4000) + (2UL << 6))) & ~(0x3 << (3 << 1))) | (0x0UL << (3 << 1));

	*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x4000) + (2UL << 6))) = (*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x4000) + (2UL << 6))) & ~(0x3 << (2 << 1))) | (0x1UL << (2 << 1));
	(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(2UL))) + ((2)<<2)))) = 1;

	*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x4000) + (2UL << 6))) = (*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x4000) + (2UL << 6))) & ~(0x3 << (1 << 1))) | (0x1UL << (1 << 1));
	(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(2UL))) + ((1)<<2)))) = 1;
	
	*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x4000) + (2UL << 6))) = (*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x4000) + (2UL << 6))) & ~(0x3 << (0 << 1))) | (0x1UL << (0 << 1));
	(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(2UL))) + ((0)<<2)))) = 1;

	*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x4000) + (1UL << 6))) = (*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x4000) + (1UL << 6))) & ~(0x3 << (10 << 1))) | (0x1UL << (10 << 1));
	*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x4000) + (2UL << 6))) = (*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x4000) + (2UL << 6))) & ~(0x3 << (13 << 1))) | (0x1UL << (13 << 1));
	*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x4000) + (2UL << 6))) = (*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x4000) + (2UL << 6))) & ~(0x3 << (12 << 1))) | (0x1UL << (12 << 1));

	*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x4000) + (0UL << 6))) = (*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x4000) + (0UL << 6))) & ~(0x3 << (13 << 1))) | (0x0UL << (13 << 1));
	
	*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x4000) + (0UL << 6))) = (*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x4000) + (0UL << 6))) & ~(0x3 << (14 << 1))) | (0x3UL << (14 << 1));
	
	*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x4000) + (3UL << 6))) = (*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x4000) + (3UL << 6))) & ~(0x3 << (2 << 1))) | (0x0UL << (2 << 1));
	*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x4000) + (3UL << 6))) = (*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x4000) + (3UL << 6))) & ~(0x3 << (3 << 1))) | (0x0UL << (3 << 1));

	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPF_MFP  &= ~((1UL<<3)  | (1UL<<2));
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPF_MFP  |= (0x00000000UL  | 0x00000000UL);
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->ALT_MFP1 &= ~((0x3UL<<26) | (0x3UL<<24));
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->ALT_MFP1 |= 0x00000000UL  | 0x00000000UL;
	*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x4000) + (5UL << 6))) = (*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x4000) + (5UL << 6))) & ~(0x3 << (2 << 1))) | (0x3UL << (2 << 1));
	(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(5UL))) + ((2)<<2)))) = 1;
	
	*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x4000) + (5UL << 6))) = (*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x4000) + (5UL << 6))) & ~(0x3 << (3 << 1))) | (0x3UL << (3 << 1));
	(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(5UL))) + ((3)<<2)))) = 1;
}
...
{	
	...
	(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(2UL))) + ((2)<<2)))) = 0;
	(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(2UL))) + ((0)<<2)))) = 0;
	OLEDCPUSendOff();
...
void LedStaticControl(LED_CONTROL_E ctrl)
{
	...
	switch(ctrl)
	{
		...
		case LED_CONTROL_MIC_OPEN:
			(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(1UL))) + ((7)<<2)))) = 0;
			(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(1UL))) + ((6)<<2)))) = 1;
			(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(5UL))) + ((3)<<2)))) = 0;
			break;
		case LED_CONTROL_MIC_APPLY:
		case LED_CONTROL_MIC_WAIT:
			(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(1UL))) + ((7)<<2)))) = 1;
			(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(1UL))) + ((6)<<2)))) = 0;
			(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(5UL))) + ((3)<<2)))) = 1;
			break;
	}	
}
...
void LedFlashPolling(void)
{
	if(info.fire_warning)
	{
		...
		{
			(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(5UL))) + ((3)<<2)))) = ~ (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(5UL))) + ((3)<<2))));
			(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(1UL))) + ((7)<<2)))) = ~ (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(1UL))) + ((7)<<2))));
			info.led_flash_count = 25;
		}
	}
	else
	{
			...
			switch(info.time_statement)
			{
				...
				case DOWN_STATEMENT:
					...
					else
					{
						HardwordCloseMic(1, mic.led);
						if(popup.enable)
							{DisplaySetPopup(POPUP_MIC_STATUS); OLEDDMAFill(128, 16, 0, 2); {(info . lang) ? (OLEDDMAShowStr("   MIC IS OFF   ", 0, 4)) : (OLEDDMAShowPic(image_mic_close, 128, 16, 0, 4));}; OLEDDMAFill(128, 16, 0, 6);};
					}
					break;
			}
		}
