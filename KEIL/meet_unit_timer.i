...
typedef enum
{
	POWER_MANAGEMENT_WAIT_LINUX_POWER_ON,
	POWER_MANAGEMENT_DAILY_OPERATION,
	POWER_MANAGEMENT_WAIT_LINUX_POWER_DOWN,
}POWER_T;
...
typedef struct 
{
	...
	u32 sock_count;
	u32 overtime_times;
	u32 overtime_0_100_count;
	u32 overtime_100_200_count;
	u32 overtime_200_300_count;
	u32 overtime_300_400_count;
	u32 overtime_400_500_count;
	u16 dis_count;
	u8  dis_flush;
}UART_TEST_T;
extern UART_TEST_T uart_test;
...
#line 4 "..\\user\\meet_unit_timer.c"
#line 1 "..\\user\\linux_command.h"
#line 4 "..\\user\\linux_command.h"
...
void LinuxCommandSend(u16 cmd, u8 *eff_data, u8 eff_data_len);
u16  LinuxRecvCheck(void);
...
#line 5 "..\\user\\meet_unit_timer.c"


void SystemTimer0Init(void)
{
	SYS_UnlockReg();
	((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1 |= (7ul << 8);
	((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->APBCLK  |= (1ul << 2); 
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000))->TCSR  = 0;
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000))->TISR  = 0x3;
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000))->TCMPR = 100;
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000))->TCSR  = (1    << 29)       | 
					(21   << 0) |	
				    (0x01 << 27)     | 
				    (1    << 30 );      
...
u16	timer0_delay_count = 0;

void TMR0_IRQHandler(void)
{
	if(timer0_delay_count)
		timer0_delay_count--;



	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000))->TISR = 1 << 0; 
}
