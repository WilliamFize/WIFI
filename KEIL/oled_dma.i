...
{
	while(((*((volatile uint32_t *)((uint32_t)&((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->CSR +(uint32_t)((0)*0x100)))&(1ul << 23))? 1 : 0));
...
{
	(*((volatile uint32_t *)((uint32_t)&((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->ISR + (uint32_t)((0)*0x100))) = ((1ul << 1)));
}
...
void OLEDDMAPolling(void)
{
	if(oled.update)
	{
		if(((*((volatile uint32_t *)((uint32_t)&((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->CSR +(uint32_t)((0)*0x100)))&(1ul << 23))? 1 : 0) == 0)
		{
			(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(2UL))) + ((13)<<2)))) = 1;
			(*((volatile uint32_t *)((uint32_t)&((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->SAR + (uint32_t)((0)*0x100))) = ((u32)oled . ram));
			PDMA_Trigger(0);
			((((SPI_T *) ((( uint32_t)0x40000000) + 0x34000)))->DMA |= (1ul << 0));
			oled.update   = 0;
		}
	}
}
...
{
	if(!oled.negation)
		memset(oled.ram, 0x00, 1024);
	else
		memset(oled.ram, 0xFF, 1024);
	OLEDDMAUpdate();
}
...
void OLEDSpiInit(void)
{
	...
	(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(1UL))) + ((10)<<2)))) = 1;
	...
	SYS_ResetModule(((0x0<<24) | 2 ));
	PDMA_Open(1 << 0);
    PDMA_SetTransferCnt(0, 0x00080000UL, 1024);
    PDMA_SetTransferAddr(0, (u32)oled.ram, 0x00000000UL, (u32)&((SPI_T *) ((( uint32_t)0x40000000) + 0x34000))->TX[0], 0x00000080UL);
	PDMA_SetTransferMode(0, 0x00000001UL, 0, 0);
    PDMA_EnableInt(0, (1ul << 1));
