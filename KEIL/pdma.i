...
void PDMA_SetTransferMode(uint32_t u32Ch, uint32_t u32Peripheral, uint32_t u32ScatterEn, uint32_t u32DescAddr)
{
    ...
    if(u32Peripheral > 0x00000010UL)  
        pdma->CSR = (pdma->CSR & ~((3ul << 2)));
    else if(u32Peripheral > 0x00000005UL)  
    ...
    switch(u32Peripheral)
    {
        ...
        case 12:
            ...
            break;
        case 13:
            ((PDMA_GCR_T *) ((( uint32_t)0x50000000) + 0x08F00))->PDSSR2 = (((PDMA_GCR_T *) ((( uint32_t)0x50000000) + 0x08F00))->PDSSR2 & ~(0xFul << 8)) | (u32Ch << 8);
            break;
        case 14:
            ((PDMA_GCR_T *) ((( uint32_t)0x50000000) + 0x08F00))->PDSSR2 = (((PDMA_GCR_T *) ((( uint32_t)0x50000000) + 0x08F00))->PDSSR2 & ~(0xFul << 12)) | (u32Ch << 12);
            break;
        case 15:
            ((PDMA_GCR_T *) ((( uint32_t)0x50000000) + 0x08F00))->PDSSR2 = (((PDMA_GCR_T *) ((( uint32_t)0x50000000) + 0x08F00))->PDSSR2 & ~(0xFul << 16)) | (u32Ch << 16);
            break;
        case 16:
            ((PDMA_GCR_T *) ((( uint32_t)0x50000000) + 0x08F00))->PDSSR2 = (((PDMA_GCR_T *) ((( uint32_t)0x50000000) + 0x08F00))->PDSSR2 & ~(0xFul << 20)) | (u32Ch << 20);
            break;
